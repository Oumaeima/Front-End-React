...
export default function DossierManagementS() {
            ...
            { data &&
                data.filter(post => {
                    ...
                    <tbody>
                                ...
                                <Link style={{marginLeft : "8px"}} data-toggle="tooltip" data-placement="bottom" title="read" className=" mr-2" to={`/dashSuperAdmin/view_dossier/${post.idd}`}>
                                    <i class="icon-user-female text-primary"></i> 
                                </Link>
                                <Link style={{marginLeft : "8px"}} data-toggle="tooltip" data-placement="bottom" title="edit" className=" mr-2" to={`/dashSuperAdmin/Edit_Dossier/${post.idd}`}>
