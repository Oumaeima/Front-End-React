...
export default function CommercialManagment() {
            ...
            <div className="wrapper">
                ...
                data.filter(post => {
                    ...
                    <tbody>
                                ...
                                <Link style={{marginLeft : "8px"}} data-toggle="tooltip" data-placement="bottom" title="edit" className=" mr-2" to={`/dashAdmin/Edit_commercial/${post.idu}`}>
